...
<body data-spy="scroll" data-target="#nav" data-offset="120">
	...
	<div class="wrapper wrapper-style1 wrapper-first">
		<article class="5grid 5grid-container" id="top">
			<div class="row">
				<div class="4u">
					<span class="me image image-full"><img src="images/me.png" class="grayscale" alt="Loic Ginoux, freelance it engineer" /></span>
				</div>
				<div class="8u">
					<header>
				...
				<article id="work">
					<div class="5grid 5grid-container">
						<div class="row">
							<div class="12u">
								<header>
									<h2>I like to get work done properly and I will always leave a happy customer.</h2>
									<span>I am here to solve your problems and come up with a solution that will fit your needs. I think that communication is the key for a successful web project. That's why I prefer to work with the <a href="http://en.wikipedia.org/wiki/Agile_software_development">Agile development methodology</a>. It consists on a iterative and incremental build approach that will allow your project to be flexible, quickly deployed and at the most effective cost (<a href="http://www.allaboutagile.com/10-good-reasons-to-do-agile-development/">read all the advantages</a>).</span>
								</header>
							</div>
						</div>
						...
						<div class="row">
							<div class="12u">
								<header>
									<h2>Not convinced?</h2>
									<span>We can also work together in a more traditional way presented below.</span>
								</header>
							</div>
						</div>
						...
						<div class="row">
							<div class="3u">
								<section class="box box-style1">
									...
									<p>This is the most important part for both of us. I will here discover and understand your needs and what you want to achieve.  The more I know about what you need to accomplish, the better my chances are of creating the website you want. We will discuss here about your goals, target users, budget and deadline.</p>
								</section>
							</div>
							<div class="3u">
								<section class="box box-style1">
									...
									<p>this is the process of taking your idea and turning it into a tangible product. We will make a mock-up of your website. We will then be able to work on the details and have a clear mind about where we are going. </p>
								</section>
							</div>
							<div class="3u">
								<section class="box box-style1">
							...
							<div class="3u">
								<section class="box box-style1">
									...
									<p>After your final approval, it's time to go live. We upload everything to your server, configure everything and do a quick check. After the launch of your project, I can help you enhance your app to ensure that it evolves and stays in sync with your business.</p>
								</section>
							</div>
						</div>
					</div>
			...
			<div class="wrapper wrapper-style3">
				<article id="portfolio">
					<header>
						<h2>Web applications and projects I worked on.</h2>
						<span>Get to know more about my different projects and web technologies I use.</span>
					</header>
					<div class="5grid 5grid-container">
						<div class="row">
							<div class="12u">
						...
						<div class="row">
							<div class="3u">
								<article class="box clickable box-style2 foodrubix">
									...
									<span class="icon  view-more icon-double-angle-down"></span>
								</article>
							</div>
							<div class="more-mobile foodrubix"></div>
							<div class="3u">
							...
							<div class="more-mobile onbrand"></div>
							<div class="3u">
							...
							<div class="more-mobile diageo"></div>
							<div class="3u">
							...
							<div class="more-mobile kts"></div>
						</div>
					</div>

					<div class="5grid 5grid-container hide more foodrubix">
						<div class="row">
							<div class="12u">
								<article class="box box-style2">
									<h3>FoodRubix</h3>

									<p>This is the application I enjoyed doing the most because I had to create everything from scratch and I was working in <strong>Agile environment</strong> with my client to offer her the best value.</p>
									<p>I also had to look into all aspects of a web projects, sketching, coding, designing, testing, and optimizing performances to nake the app.</p>
									<p>Technically, I used <strong>Ruby On Rails</strong> for the back-end, and <strong>coffeescript</strong> coupled with <strong>Spine.js</strong> for the front-end. All the static assets of this web application are hosted on <strong>Amazon S3</strong> and distributed to end users through the content delivery service <strong>Amazon Cloudfront</strong> in order to increase performances of the app.</p>
									<p>Production and testing sites are hosted on <strong>Heroku</strong> that allow quick and clean deployement of the web application using <strong>Git</strong>.</p>
									<p>This particular app has <strong>social network integration</strong> through the Facebook API and use the good Mailgun services for <strong>email management</strong>.  </p>
					...
					<div class="5grid 5grid-container hide more onbrand">
						<div class="row">
							<div class="12u">
								<article class="box box-style2">
									<h3>On Brand Application</h3>
					...
					<div class="5grid 5grid-container hide more kts">
						<div class="row">
							<div class="12u">
								<article class="box box-style2">
									<h3>Kite Tarifa School.</h3>
					...
					<div class="5grid 5grid-container hide more diageo">
						<div class="row">
							<div class="12u">
								<article class="box box-style2">
									<h3>Diageo SmartBrand</h3>
				...
				<div class="wrapper wrapper-style4">
					<article id="contact">
						<header>
							<h2>Want to hire me or just have a chat? Get in touch!</h2>
							<span>I will be happy to discuss with you about your next Facebook/Twitter secret project.</span>
						</header>
						<div class="5grid">
							<div class="row">
								<div class="12u">
